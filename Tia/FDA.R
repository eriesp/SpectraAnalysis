...
matplot(emis.x,emis.smooth ,type="l",lwd=2)
matplot(emis.x,emis.der1 ,type="l",lwd=2)
matplot(emis.x,emis.der2 ,type="l",lwd=2)
...
matplot(refl.x,refl.smooth ,type="l",lwd=2)
matplot(refl.x,refl.der1 ,type="l",lwd=2)
matplot(refl.x,refl.der2 ,type="l",lwd=2)
