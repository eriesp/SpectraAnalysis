...
silica.emis.gam = gam(silica.emis ~ s(emis.CF, bs='cr') + s(emis.CFval, bs='cr') +
                        s(emis.TF, bs='cr') + s(emis.TFval, bs='cr'))
...
anova(silica.emis.gam.reduced, silica.emis.gam, test = "F") 
### no need to smooth also the CF --> we stick with reduced model
